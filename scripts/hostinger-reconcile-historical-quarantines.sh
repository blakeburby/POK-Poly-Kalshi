...
LOCAL_SCRIPT="scripts/reconcile-historical-quarantines.ts"
...
mktemp "$APP_DIR/tmp/operator/reconcile-historical-quarantines.XXXXXX.ts"
REMOTE
)"
...
echo "Hostinger historical quarantine reconciliation target:"
