...
A few keys default to the value of _another_ key (noted inline). Three cross-field invariants are
...
| `KALSHI_PRIVATE_KEY` _(or `KALSHI_PRIVATE_KEY_B64`)_ | Kalshi RSA signing key; one of the two is required.      |
