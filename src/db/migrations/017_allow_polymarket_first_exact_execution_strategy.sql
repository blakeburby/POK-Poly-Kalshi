...
ALTER TABLE cross_venue_arb_signals
  ...
  CHECK (execution_strategy IS NULL OR execution_strategy IN ('sequential_hedge', 'parallel_canary', 'parallel_fok', 'parallel_fak', 'parallel_limit_rest', 'polymarket_first_exact'));
