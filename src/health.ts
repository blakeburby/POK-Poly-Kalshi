...
export function buildPublicWorkerHealth(options: PublicWorkerHealthOptions): Record<string, unknown> {
  ...
  const health: Record<string, unknown> = {
    ...
    liveAutoUnwindEnabled: config.liveAutoUnwindEnabled,
    liveAutoUnwindResidualOnly: config.liveAutoUnwindResidualOnly,
    liveAutoUnwindMaxLossCentsPerShare: config.liveAutoUnwindMaxLossCentsPerShare,
