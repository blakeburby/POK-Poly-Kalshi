...
>(({ className, children, ...props }, ref) => (
  <ScrollAreaPrimitive.Root ref={ref} className={cn("relative overflow-hidden", className)} {...props}>
    ...
    <ScrollAreaPrimitive.Scrollbar orientation="horizontal" className="flex h-2 touch-none select-none p-0.5">
      <ScrollAreaPrimitive.Thumb className="rounded-full bg-line-strong" />
    </ScrollAreaPrimitive.Scrollbar>
