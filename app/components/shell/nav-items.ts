...
export const NAV: NavItem[] = [
  ...
  { id: "edge", label: "Edge / Opp.", short: "Edge", icon: Crosshair, hot: "6" },
  { id: "books", label: "Order Books", short: "Books", icon: BookOpen, hot: "7" },
  { id: "health", label: "System Health", short: "Health", icon: Activity, hot: "8" },
  { id: "threeD", label: "3D Analytics", short: "3D", icon: Boxes, hot: "9" },
];
